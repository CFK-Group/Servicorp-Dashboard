...
export class ApiService {
  ...
  getReporte(tipoFormulario:string, empresa:string, fechaInicio, fechaFin){
    ...
    return this.api.get(`${this.url}/reporte/${tipoFormulario}/${fechaInicio}/${fechaFin}/${localStorage.getItem('userToken')}`, {responseType: 'blob', headers: new HttpHeaders().append('Content-Type', 'application/json') })
  }
